...
class TagCommands(commands.Cog, name="Tags"):
    ...
    async def tag(self, ctx, *, name: lambda inp: inp.lower()):
        ...
        await self.bot.db.execute("UPDATE tags SET uses = uses + 1 WHERE name = $1", name)
    ...
    async def all(self, ctx: commands.Context):
        ...
        try:
            ...
            return await ctx.send("Could not DM you. Please open DMs for this server and run the command again", delete_after=20)
