...
class PaginatorInterface(ui.View):  # pylint: disable=too-many-instance-attributes
    ...
    async def button_start(
        self, button: ui.Button, interaction: disnake.Interaction
    ...
    @ui.button(
        label="\N{BLACK LEFT-POINTING TRIANGLE}", style=disnake.ButtonStyle.secondary
    )
    ...
    @ui.button(
        label="\N{BLACK RIGHT-POINTING TRIANGLE}", style=disnake.ButtonStyle.secondary
    )
